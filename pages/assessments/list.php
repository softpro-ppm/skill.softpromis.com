...
<head>
    ...
    <title>Assessments - Softpro Skill Solutions</title>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-sm btn-danger" onclick="deleteAssessment('A001')">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-sm btn-danger" onclick="deleteAssessment('A002')">
                                    <i class="fas fa-trash"></i>
                                </button>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="btn btn-sm btn-danger" onclick="deleteAssessment('A003')">
                                    <i class="fas fa-trash"></i>
                                </button>
                            </td>
                        </tr>
