...
<head>
    ...
    <title>Edit Attendance - Softpro Skill Solutions</title>
    ...
    <main class="main-content">
        <div class="container">
            ...
            <div class="form-container">
                <form method="POST" action="edit.php?id=<?php echo $attendance_id; ?>" class="form">
                    <div class="form-group">
                        <label for="batch_id">Batch</label>
                        <select id="batch_id" name="batch_id" class="form-control" required>
                            <option value="">Select Batch</option>
                            <?php foreach ($batches as $batch): ?>
                            <option value="<?php echo $batch['id']; ?>" <?php echo $batch['id'] === $attendance['batch_id'] ? 'selected' : ''; ?>>
                                <?php echo $batch['name']; ?>
                            </option>
                            <?php endforeach; ?>
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="date" name="date" class="form-control" value="<?php echo $attendance['date']; ?>" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="status" name="status" class="form-control" required>
                            ...
                            <option value="completed" <?php echo $attendance['status'] === 'completed' ? 'selected' : ''; ?>>Completed</option>
                        </select>
                    </div>

                    <div class="form-group">
                        <label for="remarks">Remarks</label>
                        <textarea id="remarks" name="remarks" class="form-control" rows="3"><?php echo $attendance['remarks']; ?></textarea>
                    </div>
                            ...
                            <table class="data-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="attendance_data[<?php echo $student['id']; ?>][remarks]" class="form-control" value="<?php echo $student['remarks']; ?>" placeholder="Add remarks">
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
